...
#ifndef MEDECIN_REMPLACANT_SWIFT_H
#define MEDECIN_REMPLACANT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="medecin_remplacant",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC18medecin_remplacant11AppDelegate")
...
SWIFT_CLASS("_TtC18medecin_remplacant17MainFlutterWindow")
